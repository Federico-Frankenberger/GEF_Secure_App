...
| [`05-database.md`](05-database.md) | Modelo de datos y cómo evolucionó el esquema (`init/00`→`init/29`) |
...
| [`diagrams/`](diagrams/README.md) | ERD, contexto/componentes, secuencias y despliegue (Mermaid) |
